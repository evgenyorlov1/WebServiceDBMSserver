 ...
 * @author pc
 */
@WebService(endpointInterface = "server.DbmsWebService")
public class DbmsWebServiceImpl implements DbmsWebService {
    ...
    @Override
    public String sort(String DBname, String Tname, String key, int num) {
        return adapter.sort(DBname, Tname, key, num);
    }
